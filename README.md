...
Tree CLI is a command-line application written in Zig that recursively lists and displays directory structures and files directly in the terminal, compatible with any operating system.
